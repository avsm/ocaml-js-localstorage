...
(* OASIS_START *)
(* DO NOT EDIT (digest: 93a2405ff73f48455547344738009062) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "looper.ml"; });
               Executable
                 ({
                     cs_name = "filler";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "filler.ml"; })
            ];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\\\011\004≤® \130x\145¿¢\159 „√j";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
