...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74eeb6dc66e4ea44d5255d4bb887d1b2) *)
(*
...
let setup_t =
  {
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("./makejs.sh", [])))];
               };
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "localStorage"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "localstorage_looper.ml";
                      });
               Executable
                 ({
                     cs_name = "localstorage_filler";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "localstorage_filler.ml";
                      })
            ];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "M\144Ì^ Ë.7TÄÉ@5·\156q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
